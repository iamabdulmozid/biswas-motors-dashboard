...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  const getPageTitle = (): string => {
    ...
    if (path === '/pos') return t('nav.pos');
    if (path.startsWith('/accounts')) {
      if (path === '/accounts/summary') return t('nav.daySummary');
      if (path === '/accounts/transactions') return t('nav.transactions');
      if (path === '/accounts/withdraw') return t('nav.withdraw');
      return 'Accounts';
    }
    
    return 'Biswas Motors';
  };
