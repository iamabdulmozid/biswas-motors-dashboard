...
export default function Sidebar({ isOpen, isCollapsed, onClose, onToggleCollapse }: SidebarProps) {
  ...
  const navItems: NavItem[] = [
    ...
    { path: "/pos", label: t('nav.pos'), icon: <POSIcon className="w-5 h-5" /> },
  ];
            ...
            <div className="h-14 flex items-center justify-center">
              {isCollapsed ? (
                ...
                <div className="w-full">
                  ...
                  <p className="text-sm text-neutral-500 mt-1 whitespace-nowrap">অ্যাডমিন পোর্টাল</p>
                </div>
              )}
            </div>
          </div>
